      ...
      <div className="relative mt-16">
        ...
        <div className="w-full h-[500px]  bg-cover bg-center relative bg-[rgba(0,0,0,0.9)]">
          ...
          <img
            ...
            alt=""
            className="z-10 object-contain object-center w-full h-full"
          />
        </div>
        {/* Title */}
        ...
        <div className="w-full max-w-7xl mx-auto lg:flex">
          ...
          <div className="w-2/3 p-8 mb-16">
            <h3 className="text-4xl font-semibold mb-4 text-red-500">
              - 레시피
            </h3>
            <ol className=" list-none ">
              <li className="mt-8 text-[18px] font-semibold">
                {item?.MANUAL01}
              </li>
              <img
                src={item?.MANUAL_IMG01}
                alt=""
          ...
          <div className="lg:w-1/3 p-8 border lg:h-[600px]">
            ...
            <div className="pl-6">
              <p className="mb-2">
                <strong>탄수화물:</strong> {item?.INFO_CAR}
              </p>
              <p className="mb-2">
                <strong>단백질:</strong> {item?.INFO_PRO}
              </p>
              <p className="mb-2">
                <strong>지방:</strong> {item?.INFO_FAT}
              </p>
              <p className="mb-2">
                <strong>나트륨:</strong> {item?.INFO_NA}
              </p>
              <p className="mb-2">
                <strong>에너지:</strong> {item?.INFO_ENG}
              </p>
            </div>
          </div>
        </div>
